...
max_counter=16;%number of topology to make converge, 1 runs take several hours to converge, expect 8/9 converged shapes per day
for counter=1:1:max_counter
...
%                 disp('*********Best topology detected !**********')
            ...
            imwrite(arbre,['Data/',prefix,'_Topology_kp_ko_',num2str(high_conductivity),'_phi_',num2str(filling_ratio),'.png']);
            end
