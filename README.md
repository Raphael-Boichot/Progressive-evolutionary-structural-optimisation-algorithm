...
## Another exemple of convergence steps with kp/k0=10 and filling ratio = 0.3, domain size from 1x to 8x (20 steps per frame), max temperature minimization

![PESO algorithm](Pictures/Figure_2.gif)
